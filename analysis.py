...
# Load data
transactions = pd.read_csv('processed_data/transactions.csv')
seller_list = pd.read_csv('processed_data/seller_list.csv')
...
merged_df = pd.read_csv('processed_data/merged_reddit_data.csv', usecols=['parsedId', 'dataType', 'transaction_value', 'payment_method', 'item_type'], dtype=str)
...
plt.savefig('visualizations/embedding_umap.png')
print("Saved visualization to visualizations/embedding_umap.png")



import datetime
results_file = open("research_questions_results.txt", "w", encoding="utf-8")
